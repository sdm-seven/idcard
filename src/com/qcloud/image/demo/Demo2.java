...
public class Demo2 {
	public static void main(String[] args) {
		...
		String appId = "1253648361";
		String secretId = "AKIDlU6Rjw6iliP6nNqnJzXu59ugMsJWbeVB";
		String secretKey = "oo4GIBxduFfJ3hRk6R7OT1Us8Ugnoruq";
		String bucketName = "checkidbucketname-1";
...
//		faceIdCardLiveDetectFour(imageClient, bucketName,"1093");
//		faceLiveDetectFour(imageClient, bucketName,validate);
//		faceLiveDetectPicture(imageClient, bucketName);// 人脸静态活体检测
		AuthIdCardCompare(imageClient, bucketName,"张盼", "420583199102133718", null);
	}
	...
	private static void faceIdCardLiveDetectFour(ImageClient imageClient, String bucketName, String validate) {
		String ret;
		System.out.println("====================================================");
		String liveDetectIdcardNumber = "420583199102133718";
		String liveDetectIdcardName = "张盼";
		File video = new File("/home/81c6d03fab33dec22687ea60f307e347.mp4");
	...
	private static void faceIdCardCompare(ImageClient imageClient, String bucketName) {
		...
		// 1. url方式
		System.out.println("====================================================");
		String idcardNumber = "420583199102133718";
		String idcardName = "张盼";
		...
		try {
			idcardCompareName = "微信图片_20180513220851.jpg";
			idcardCompareImage = new File("微信图片_20180513220851.jpg");
		} catch (Exception ex) {
...
//		}
		...
		AuthIdCardCompareRequest idCardCompareReq = new AuthIdCardCompareRequest(bucketName, idcardNumber, idcardName, sessionId);
