...
import com.qcloud.image.demo.Demo2;
import com.qcloud.image.request.AuthIdCardCompareRequest;
...
public class ImgUtils {
	 ...
	 * 身份证识别对比接口
	 */
	public static String AuthIdCardCompare(ImageClient imageClient, String bucketName,String idcardName,String idcardNumber,String imgUrl) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
		String sessionId = "";
		String idcardCompareName=imgUrl;
		File idcardCompareImage = null;
		try {
			idcardCompareImage = new File(idcardCompareName);
		} catch (Exception ex) {
			Logger.getLogger(Demo2.class.getName()).log(Level.SEVERE, null, ex);
		}

		AuthIdCardCompareRequest idCardCompareReq = new AuthIdCardCompareRequest(bucketName, idcardNumber, idcardName,idcardCompareName, idcardCompareImage, sessionId);

		ret = imageClient.AuthIdCardCompare(idCardCompareReq);
	 ...
	 */
	public static void faceLiveDetectPicture(ImageClient imageClient, String bucketName) {
		String result;
		 ...
		 * System.out.println("====================================================");
		 * String imageUrl =
		 * "http://open.youtu.qq.com/app/img/experience/face_img/face_34.jpg";// 照片url
		 * request = new FaceLiveDetectPictureRequest(bucketName, imageUrl); result =
		 * imageClient.faceLiveDetectPicture(request, useNewDomain);
		 * System.out.println("face  live detect picture result:" + result);
		 */
		// 2. 图片内容方式
		System.out.println("====================================================");
		File image = new File("lxb.jpg");
	 ...
	 * 检测视频和身份证是否对上操作
	 */
	public static void faceLiveDetectFour(ImageClient imageClient, String bucketName, String validate) {
		String ret;
		System.out.println("====================================================");
		boolean compareFlag = true;
		File liveDetectImage = new File("lxb.jpg");
		File video = new File("lxb.mp4");
	 ...
	 * 通过视频对比指定身份信息接口
	 */
	public static void faceIdCardLiveDetectFour(ImageClient imageClient, String bucketName, String validate) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 身份证识别对比接口
	 */
	public static void faceIdCardCompare(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
		String idcardNumber = "420222198909103778";
		String idcardName = "李晓霸";
	 ...
	 * 人脸对比操作
	 */
	public static void faceFaceCompare(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 */
	public static void faceMultiIdentifyRequest(ImageClient imageClient, String bucketName) {
	 ...
	 * 人脸识别操作
	 */
	public static void faceFaceIdentify(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
		...
		// groupIds, faceImageUrl);// 多个 groupId
		...
		// groupIds, faceImageFile);// 多个 groupId
	 ...
	 * 人脸验证操作
	 */
	public static void faceFaceVerify(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 获取人脸信息
	 */
	public static void faceGetFaceInfo(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 获取人脸列表
	 */
	public static void faceGetFaceIdList(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 获取人列表
	 */
	public static void faceGetPersonId(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 获取组列表
	 */
	public static void faceGetGroupId(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 */
	public static void faceAddGroupId(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 */
	public static void faceDelGroupId(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 个体获取信息
	 */
	public static void faceGetInfo(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 个体设置信息
	 */
	public static void faceSetInfo(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 人脸删除操作
	 */
	public static void faceDelFace(ImageClient imageClient, String bucketName) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 增加人脸操作
	 */
	public static void faceAddFace(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 个人删除操作
	 */
	public static void faceDelPerson(ImageClient imageClient, String bucketName, String personId) {
		String ret;
		System.out.println("====================================================");
	 ...
	 * 个体添加操作
	 */
	public static String faceNewPerson(ImageClient imageClient, String bucketName) {
		String ret;
	 ...
	 * 五官定位操作
	 */
	public static void faceShape(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 人脸检测操作
	 */
	public static void faceDetect(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 名片ocr识别操作
	 */
	public static void ocrNameCard(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * OCR-银行卡识别
	 */
	public static void ocrBankCard(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * OCR-车牌识别
	 */
	public static void ocrPlate(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 身份证ocr识别操作
	 */
	public static void ocrIdCard(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式,识别身份证正面
		System.out.println("====================================================");
	 ...
	 * 标签识别操作
	 */
	public static void imageTag(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
	 ...
	 * 黄图识别操作
	 */
	public static void imagePorn(ImageClient imageClient, String bucketName) {
		String ret;
		// 1. url方式
		System.out.println("====================================================");
