...
public class ImageClient implements Image {
    ...
    @Override
    public String AuthIdCardCompare(AuthIdCardCompareRequest request) {
        try {
            return detectionOp.AuthIdCardCompare(request);
        } catch (AbstractImageException e) {
            recordException("AuthIdCardCompare", request, e.toString());
            return e.toString();
        } catch (Exception e) {
            UnknownException e1 = new UnknownException(e.toString());
            recordException("AuthIdCardCompare", request, e1.toString());
            return e1.toString();
        }
    }
